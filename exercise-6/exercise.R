...
husky.opponent <- c(husky.games.2015$opponent)
...
husky.games.2015$total.yards <- combined.yards
...
the.score <- husky.scores[combined.yards == max(husky.games.2015$combined.yards)]
